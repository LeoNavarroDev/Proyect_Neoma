...
vec3 auroraColors(float t) {
  // Aurora colors: dark blues, purples and greens
  vec3 c1 = vec3(0.3, 0.1, 0.5);  // Deep purple
vec3 c2 = vec3(0.1, 0.6, 0.7);  // Teal blue
vec3 c3 = vec3(0.2, 0.9, 0.5);  // Vibrant green
vec3 c4 = vec3(0.6, 0.2, 0.6);  // Magenta/purple


  
  float p1 = smoothstep(0.0, 0.33, t);
  float p2 = smoothstep(0.33, 0.66, t);
  float p3 = smoothstep(0.66, 1.0, t);
