...
vec3 auroraColors(float t) {
  ...
  vec3 c1 = vec3(0.0, 0.5, 0.6);   // Verde azulado
  vec3 c2 = vec3(0.3, 0.4, 0.9);   // Azul eléctrico
  vec3 c3 = vec3(0.7, 0.2, 0.8);   // Púrpura neón
  vec3 c4 = vec3(0.9, 0.4, 0.5);   // Rosa atmosférico
